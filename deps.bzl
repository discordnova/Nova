...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:O7R8kajfkEg2BgSn+blItMi0j3T83ps5hwv86HtlSN4=",
        version = "v8.1.1",
    )
    go_repository(
        name = "com_github_go_redsync_redsync_v4",
        importpath = "github.com/go-redsync/redsync/v4",
        sum = "h1:Z0AaOpoLvzfZwLK+3uCDHcTxOXck2juzumu1EPJwCUI=",
        version = "v4.4.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:zDT8ke8y2aP4wf9zPTB2uSIeavJ3Hx/ceY4jxI2JxuY=",
        version = "v1.3.1",
    )
    go_repository(
        name = "com_github_hashicorp_raft_boltdb",
        importpath = "github.com/hashicorp/raft-boltdb",
        sum = "h1:EfDtu7qY4bD9hNY9sIryn1L/Ycvo+/WPEFT2Crwdclg=",
        version = "v0.0.0-20210422161416-485fa74b0b01",
    )
    ...
    go_repository(
        name = "com_github_jille_raft_grpc_transport",
        importpath = "github.com/Jille/raft-grpc-transport",
        sum = "h1:W/YSPz8IsirEyomjKmDog5Xk71o9+l4KhyMEX2TsgSs=",
        version = "v1.2.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:kuk8nKPQ25KCDODLCDXt99tnTVeOyOM8HGvtJ0NzAvw=",
        version = "v0.0.0-20210907225631-ff17edfbf26d",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:GkvMjFtXUmahfDtashnc1mnrCtuBVcwse5QV2lUk/tI=",
        version = "v0.0.0-20210906170528-6f6e22806c34",
    )
    go_repository(
